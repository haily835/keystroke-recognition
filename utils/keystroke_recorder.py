...
class TypingTestApp:
    ...
    def update_text_display(self):
        # Check if both video and CSV files exist
        video_file = f'video-{self.current_text_index}.mp4'
        csv_file = f'video-{self.current_text_index}.csv'
        files_exist = os.path.exists(video_file) and os.path.exists(csv_file)
    ...
    def start_recording(self):
        if not self.recording:
            ...
            video_filename = f'video-{self.current_text_index}.mp4'
    ...
    def stop_recording(self):
        if self.recording:
            ...
            csv_filename = f'video-{self.current_text_index}.csv'
            ...
            print(f"Key timings saved to {csv_filename}")
            self.update_text_display()
