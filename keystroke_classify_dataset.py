...
def video_segments(video_name, destination_base):
    ...
    source_folder = f'./videos/{video_name}'  # Update with your source folder containing video folders
    ...
    for index, row in df.iterrows():
        ...
        for i in range(key_frame - 3, key_frame + 5):
            ...
            # destination_frame_path_1 = os.path.join(destination_subfolder_path, f'frame_{i}_1.png')
            # destination_frame_path_2 = os.path.join(destination_subfolder_path, f'frame_{i}_2.png')
...
if __name__ == '__main__':
    ...
    destination_base = f'./keystroke_classify_data/{mode}'
